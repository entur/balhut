...
import org.entur.balhut.BalhutApplication;
...
@SpringBootTest(
        ...
        classes = BalhutApplication.class
)
public class AddressesDataRouteBuilderTest {
    ...
    public void shouldInjectEndpoint() throws InterruptedException, IOException {
        ...
        ReflectionTestUtils.setField(addressesDataRouteBuilder, "balhutWorkDir", workingDirectory.toString());

        InputStream adminUnits = this.getClass().getResourceAsStream("/org/entur/balhut/camel/tiamat_export_geocoder_latest.zip");
        InputStream addresses = this.getClass().getResourceAsStream("/org/entur/balhut/camel/Basisdata_0000_Norge_25833_MatrikkelenAdresse_CSV.zip");
        InputStream result = this.getClass().getResourceAsStream("/org/entur/balhut/camel/balhut_export_geocoder_1663155120267.zip");
